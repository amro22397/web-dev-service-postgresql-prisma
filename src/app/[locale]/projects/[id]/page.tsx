...
export default async function page(props: PageProps) {
    ...
    const mProject = await Project.findById({_id: id})
        const project = JSON.parse(JSON.stringify(mProject))

    console.log(project);

    const projectByIdPage = await getTranslations("ProjectByIdPage");
            ...
            >
                ...
                flex flex-row items-center gap-2"
                        ...
                        mt-[2px]"
                                ...
                                {projectByIdPage("Back to projects")}
                            </button>
                        </Link>
                    ...
                    <div className="flex flex-col gap-5 h-[50%]">
                        ...
                        <p className="project-id-date"
                        style={{fontFamily: "Arial, Helvetica, sans-serif"}}
                        >{project.date}</p>

                        <p
                            className="project-id-description
                        "
                        style={{fontFamily: "Arial, Helvetica, sans-serif"}}
                        >
                            {project.description}
                        ...
                        */}
                        ...
                        <div
                            className="project-id-border-after-technologies
                        "
                        ></div>
                        ...
                        <div className="flex items-center gap-4">
                            {project.link.trim(" ") === "" ? (
                                ...
                                px-5 py-1 rounded-full hover:bg-blue-800 active:bg-blue-900"
                                    >
                                        {projectByIdPage("Visit the website")}
