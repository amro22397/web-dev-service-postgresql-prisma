...
const ContactForm = ({
  ...
  const handleSubmit = async (e: any) => {
    ...
    if (res.ok && result.success) {
      toast.success(contactPage("Form is submitted successfully"));
      setYourName("");
      setEmail("");
      setPhoneNumber("");
      setWhatsappNumber("");
    ...
    >
      ...
      >
        ...
        <Input
          ...
          id="websiteName"
          value={websiteName}
          className="contact-us-input-style hidden"
        />
        ...
        <Button
          ...
          className="max-w-40 py-2 bg-indigo-600 hover:bg-indigo-700
              active:scale-95 text-white disabled:bg-gray-400 cursor-pointer"
          disabled={loading}
          style={{ borderRadius: ".25rem" }}
        >
